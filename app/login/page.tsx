        ...
        <div className="w-full max-w-[360px] flex flex-col items-center space-y-4 md:space-y-6">
          ...
          <Card className="w-full border-gray-100 bg-[#f9fafb]/50 shadow-sm rounded-xl overflow-hidden border">
            <CardContent className="p-6 md:p-8 space-y-5 md:space-y-6">
              <div className="text-center space-y-0.5">
                <h2 className="text-lg md:text-xl font-bold text-gray-900 leading-tight">Welcome back</h2>
                <p className="text-xs text-gray-400 font-medium">Login into your HMS Portal</p>
              </div>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-1">
                  <Label htmlFor="password" title="Password" className="text-[10px] font-bold text-gray-900 uppercase tracking-tight">Password</Label>
          ...
          <div className="text-center pt-2">
            <p className="text-[8px] md:text-[9px] font-bold text-gray-400 max-w-[240px] leading-relaxed mx-auto uppercase tracking-tighter">
              By clicking continue, you agree to our <Link href="#" className="underline decoration-gray-300 hover:text-gray-600 transition-colors">Terms of Service</Link> and <Link href="#" className="underline decoration-gray-300 hover:text-gray-600 transition-colors">Privacy Policy</Link>.
            </p>
          </div>
        </div>
      </div>
