...
const chats = [
  {
    id: 1,
    name: "Amara Osei",
    preview: "I wanted to check the status of my...",
    time: "10:45 AM",
    unread: 2,
    online: true,
  },
  {
    ...
    preview: "Please note the change in shift...",
    time: "Yesterday",
    unread: 0,
    online: false,
  },
  {
    ...
    preview: "The leaking faucet in B204 has been...",
    time: "Mon",
    unread: 0,
    online: true,
  },
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 bg-gray-50/20">
          ...
          <div className="flex items-start gap-4 max-w-2xl">
            ...
            <div className="space-y-2">
              ...
              <span className="text-[9px] font-bold text-gray-400 uppercase ml-1">
                10:45 AM
              </span>
            </div>
          </div>
